...
my.wd = "~/Desktop/full_run_read_data"
setwd(my.wd)
...
source(paste0(getwd(),"/agony_constraints.R"))
...
# STEP 1: first bootstrap to estimate the poset
...
confidence_based_poset_binary_example = perform.consensus.likelihood.fit(bootstrap_poset_binary_example,dataset_example_discrete,"bic")
confidence_based_poset_continuous_example = perform.consensus.likelihood.fit(bootstrap_poset_continuous_example,dataset_example_continuous,"bic-g")
