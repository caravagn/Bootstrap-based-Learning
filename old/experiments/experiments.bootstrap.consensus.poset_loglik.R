...
setwd("~/Desktop/results_bootstrap_consensus_poset_loglik")
...
results_bootstrap_consensus_poset_loglik = NULL
                ...
                for (samples in names(results_bootstrap[["run"]][[runs]][[var]][["node_size"]][["10"]][["density"]][[den]][["reconstructions"]])) {
                    for (noise_levels in names(results_bootstrap[["run"]][[runs]][[var]][["node_size"]][["10"]][["density"]][[den]][["reconstructions"]][[samples]])) {
                        for (reg in names(results_bootstrap[["run"]][[runs]][[var]][["node_size"]][["10"]][["density"]][[den]][["reconstructions"]][[samples]][[noise_levels]])) {
                            ...
                            my.curr_bot_reg = "adj.matrix.loglik.hc"
                            if(var=="continuous") {
                            ...
                            curr_bootstrap_results = results_bootstrap[["run"]][[runs]][[var]][["node_size"]][["10"]][["density"]][[den]][["reconstructions"]][[samples]][[noise_levels]][[my.curr_bot_reg]][["boot"]]
                            ...
                            # save the results
                            results_bootstrap_consensus_poset_loglik[["run"]][[runs]][[var]][["node_size"]][["10"]][["density"]][[den]][["adj.matrix"]][["adj.matrix.true"]] = curr_ground_true
                            results_bootstrap_consensus_poset_loglik[["run"]][[runs]][[var]][["node_size"]][["10"]][["density"]][[den]][["reconstructions"]][[samples]][[noise_levels]][[reg]] = curr_consensus_estimation
                            results_bootstrap_consensus_poset_loglik[["run"]][[runs]][[var]][["node_size"]][["10"]][["density"]][[den]][["stats"]][[samples]][[noise_levels]][[reg]] = curr_stats
                        }
                    }
                }
            #}
...
# save the results
save(results_bootstrap_consensus_poset_loglik,file="results_bootstrap_consensus_poset_loglik.RData")
