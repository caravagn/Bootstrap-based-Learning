...
for (i in all.files) {
    ...
    if(name.res=="adj.matrix") {
        ...
        restuls_hc_tabu[[curr_split[1]]][[curr_split[2]]][[curr_split[3]]][[curr_split[4]]][[curr_split[5]]][[curr_split[6]]][[curr_split[7]]][[name.res]][[gsub(".txt","",unlist(strsplit(curr_split[8],"_")))[4]]][gsub(".txt","",unlist(strsplit(curr_split[8],"_")))[7]] = list(curr_result)
    }
    ...
    if(name.res=="reconstructions") {
        ...
        restuls_hc_tabu[[curr_split[1]]][[curr_split[2]]][[curr_split[3]]][[curr_split[4]]][[curr_split[5]]][[curr_split[6]]][[curr_split[7]]][["statistics"]][[gsub(".txt","",unlist(strsplit(curr_split[8],"_")))[4]]][gsub(".txt","",unlist(strsplit(curr_split[8],"_")))[7]] = list(curr_stats)
    }
